  ...
  function setTabsAction(e) {
    ...
    if (el.closest("[data-fls-tabs-title]")) {
      ...
      if (!tabsBlock.querySelector(".--slide")) {
        const isClosable = tabsBlock.hasAttribute("data-fls-tabs-closable");
        if (tabTitle.classList.contains("--tab-active") && isClosable) {
          tabTitle.classList.remove("--tab-active");
          setTabsStatus(tabsBlock);
          if (tabsBlock.hasAttribute("data-fls-tabs-hash")) {
            setHash("");
          }
        } else if (!tabTitle.classList.contains("--tab-active")) {
          let tabActiveTitle = tabsBlock.querySelector("[data-fls-tabs-title].--tab-active");
          if (tabActiveTitle) {
...
function addToCart() {
  ...
  function flyToCart(productImg, cartIcon2) {
    ...
    const cartRect = cartIcon2.getBoundingClientRect();
    ...
    setTimeout(() => {
      imgClone.remove();
      cartIcon2.classList.add("shake-cart");
      setTimeout(() => cartIcon2.classList.remove("shake-cart"), 300);
    }, 700);
  }
}
