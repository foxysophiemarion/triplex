 ...
 * @license GPLv3
 */
var lgPager_min = lgPager_min$1.exports;
var hasRequiredLgPager_min;
function requireLgPager_min() {
  if (hasRequiredLgPager_min) return lgPager_min$1.exports;
  hasRequiredLgPager_min = 1;
  (function(module, exports) {
    !function(e, t) {
      module.exports = t();
    }(lgPager_min, function() {
      var e = function() {
        return (e = Object.assign || function(e2) {
          for (var t2, r2 = 1, o2 = arguments.length; r2 < o2; r2++) for (var i in t2 = arguments[r2]) Object.prototype.hasOwnProperty.call(t2, i) && (e2[i] = t2[i]);
          return e2;
        }).apply(this, arguments);
      }, t = "lgUpdateSlides", r = "lgBeforeSlide", o = { pager: true };
      return function() {
        function i(t2, r2) {
          return this.core = t2, this.$LG = r2, this.settings = e(e({}, o), this.core.settings), this;
        }
        return i.prototype.getPagerHtml = function(e2) {
          for (var t2 = "", r2 = 0; r2 < e2.length; r2++) t2 += '<span  data-lg-item-id="' + r2 + '" class="lg-pager-cont"> \n                    <span data-lg-item-id="' + r2 + '" class="lg-pager"></span>\n                    <div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + e2[r2].thumb + '" /></div>\n                    </span>';
          return t2;
          ...
          if (this.settings.pager) {
            ...
            var i2 = this.core.outer.find(".lg-pager-outer");
            i2.html(this.getPagerHtml(this.core.galleryItems)), i2.first().on("click.lg touchend.lg", function(t2) {
              var r2 = e2.$LG(t2.target);
              if (r2.hasAttribute("data-lg-item-id")) {
                var o3 = parseInt(r2.attr("data-lg-item-id"));
                e2.core.slide(o3, false, true, false);
              }
            }), i2.first().on("mouseover.lg", function() {
              clearTimeout(o2), i2.addClass("lg-pager-hover");
            }), i2.first().on("mouseout.lg", function() {
              o2 = setTimeout(function() {
                i2.removeClass("lg-pager-hover");
              });
            }), this.core.LGel.on(r + ".pager", function(t2) {
              var r2 = t2.detail.index;
              e2.manageActiveClass.call(e2, r2);
            }), this.core.LGel.on(t + ".pager", function() {
              i2.empty(), i2.html(e2.getPagerHtml(e2.core.galleryItems)), e2.manageActiveClass(e2.core.index);
            });
          }
        }, i.prototype.manageActiveClass = function(e2) {
          var t2 = this.core.outer.find(".lg-pager-cont");
          t2.removeClass("lg-pager-active"), t2.eq(e2).addClass("lg-pager-active");
