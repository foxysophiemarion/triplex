  ...
  if (spollersArray.length > 0) {
    let initSpollers2 = function(spollersArray2, matchMedia = false) {
      spollersArray2.forEach((spollersBlock) => {
        ...
        const mode = spollersBlock.dataset.flsSpollersMode || "click";
        if (matchMedia.matches || !matchMedia) {
          spollersBlock.classList.add("--spoller-init");
          initSpollerBody2(spollersBlock);
          spollersBlock.removeEventListener("click", setSpollerAction2);
          spollersBlock.removeEventListener("mouseover", setSpollerAction2);
          spollersBlock.addEventListener(mode === "hover" ? "mouseover" : "click", setSpollerAction2);
          document.addEventListener("click", handleSpollerClose2);
        } else {
          spollersBlock.classList.remove("--spoller-init");
          initSpollerBody2(spollersBlock, false);
          spollersBlock.removeEventListener("click", setSpollerAction2);
          spollersBlock.removeEventListener("mouseover", setSpollerAction2);
          document.removeEventListener("click", handleSpollerClose2);
        }
      });
      ...
      if (el.closest("summary") && el.closest("[data-fls-spollers]")) {
        ...
        const spollerSpeed = spollersBlock.dataset.flsSpollersSpeed ? parseInt(spollersBlock.dataset.flsSpollersSpeed) : 50;
    ...
    }, handleSpollerClose2 = function(e) {
      const el = e.target;
    ...
    var initSpollers = initSpollers2, initSpollerBody = initSpollerBody2, setSpollerAction = setSpollerAction2, handleSpollerClose = handleSpollerClose2, hideSpollersBody = hideSpollersBody2;
