import { s as slideUp, a as slideToggle, f as formValidate, d as dataMediaQueries, b as slideDown } from "./app.min.js";
class SelectConstructor {
  constructor(props, data = null) {
    ...
    this.selectClasses = {
      ...
      // Тело селекта
      classSelectTitle: "select__title--icon-spoller-right",
      // Заголовок
      ...
      classSelectOption: "select__option--icon-check",
      // Пункт
